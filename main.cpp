...
int main(int argc, char** argv) {
    ...
    if (procid == 0)
    {
        ...
        MPI_Bcast(&transactionsPool, transactionsPool.size(), MPI_INT, 0, MPI_COMM_WORLD);
        ...
        MPI_Bcast(&transactionsPool, transactionsPool.size(), MPI_INT, 0, MPI_COMM_WORLD); //ikopijuoja tuscia vektoriu
